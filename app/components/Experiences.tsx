      ...
      <div className='grow flex bg-red-200'>
        <div className='bg-base-100'>
          ...
          <p className={`text-lg mt-4 text-base-content`}>
            With a degree in computer security and extensive experience in the field, I am well-equipped to assist you with your upcoming project. As
            a full-stack developer I bring a diverse skill set, a broad range of technologies, expertise, and a strong passion for learning the
            newest. Feel free to explore my portfolio, and let's work together on your project.
          </p>
