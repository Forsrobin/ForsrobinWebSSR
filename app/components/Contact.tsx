          ...
          <Form method='post' className='space-y-8'>
            <div>
              ...
              <input
                ...
                name='email'
                id='email'
                className='shadow-sm text-sm rounded-lg focus:ring-primary-500  block w-full p-2.5 bg-gray-700  placeholder-gray-400 text-white focus:ring-primary-500 focus:border-primary-500 shadow-sm-light'
            ...
            <div>
              ...
              <input
                ...
                id='subject'
                name='subject'
                className='block p-3 w-full text-sm  rounded-lg  shadow-sm focus:ring-primary-500  bg-gray-700  placeholder-gray-400 text-white focus:ring-primary-500 focus:border-primary-500 shadow-sm-light'
            ...
            <div className='sm:col-span-2'>
              ...
              <textarea
                ...
                minLength={10}
                rows={4}
                className='block p-2.5 w-full text-sm rounded-lg shadow-sm   focus:ring-primary-500  bg-gray-700  placeholder-gray-400 text-white focus:ring-primary-500 focus:border-primary-500'
