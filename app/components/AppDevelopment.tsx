  ...
  return (
    <div id='experience' className='w-full bg-white flex flex-col px-10 md:px-40 lg:flex-row grow p-20 pb-10 relative'>
      <div className='flex flex-col'>
        ...
        <div className='w-full md:w-3/5'>
          <p className='text-gray text-base md:text-lg font-light'>
            ...
            expertise extends to creating seamless user experiences and ensuring compatibility across multiple devices. I bring a wealth of knowledge
            and a proven track record in developing complex mobile applications
          </p>
        </div>
      ...
      <div className='absolute hidden transition-all md:block lg:block w-96 right-0 mt-10 md:mt-40 md:-right-40 lg:mt-28 lg:-right-10 xl:-right-0 xl:mt-5'>
        <img
          className='absolute w-96 right-0 transition ease-in-out transform hover:-translate-y-10 motion-reduce:transition-none motion-reduce:hover:transform-none '
          src={PhoneOne}
          alt='Designed by mockup.store at freepik.com'
        />
        <img className='absolute w-96 -right-72 top-0 ' src={PhoneOne} alt='Designed by mockup.store at freepik.com' />
        <img
        ...
        />
        <img
          className='absolute w-96 right-32 top-40 transition ease-in-out transform hover:-translate-y-10 motion-reduce:transition-none motion-reduce:hover:transform-none'
          src={PhoneTwo}
          alt='Designed by mockup.store at freepik.com'
        />
      </div>
      ...
      <div className='flex md:hidden lg:hidden w-full mt-10 justify-center'>
        <img
          className='w-96 right-0 transition ease-in-out transform hover:-translate-y-5 motion-reduce:transition-none motion-reduce:hover:transform-none '
          src={PhoneOne}
          alt='Designed by mockup.store at freepik.com'
        />
      </div>
